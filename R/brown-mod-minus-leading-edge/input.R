...
brown.mod = fread(file.path(PROJECT_DIR, "generated_data/WGCNA-modules-from-SLE-low-DA/SLE-low-34sbj-9601probes-gene.in.module.minModSize20.signed-hybrid.txt"))[which(Module %in% "brown")]$Symbol
brown.minus.LE = setdiff(toupper(brown.mod), brown.LE.isv050)
