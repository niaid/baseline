...
```
# CRAN:
install.packages(c("plyr", "tidyverse", "data.table", "pROC", "lme4", "tmod", "MASS", "latex2exp", "xtable", "gplots", "GGally", "effects", "stargazer", "car", "gdata", "effsize", "formatR", "cowplot"))

# Bioconductor 3.4:
source("http://bioconductor.org/biocLite.R")
biocLite()
biocLite(c("hgu133plus2.db","illuminaHumanv4.db","GO.db", "WGCNA","fgsea","impute","qusage",
"BitSeq"))
